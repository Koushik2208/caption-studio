...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex fixed left-0 top-16 bottom-0 flex-col p-4 gap-stack-gap border-r bg-surface border-border w-[80px] lg:w-panel-width z-40 transition-all">
        <div className="hidden lg:block mb-6 px-3">
          <h2 className="text-headline-md font-headline-md font-bold text-text-primary">Tools</h2>
          <p className="text-body-sm font-body-sm text-text-muted">Project v1.0</p>
        </div>
      ...
      <nav
        ...
        className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-surface/95 backdrop-blur-md border-t border-border flex items-center justify-around px-1 z-40"
      >
