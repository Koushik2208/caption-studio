...
import { CreativeJsonImporter } from '../components/import/CreativeJsonImporter';
      ...
      <aside className="w-full bg-surface-container-low flex flex-col h-full shrink-0 grow-0 overflow-hidden">
        ...
        <div className="p-4 border-b border-outline-variant">
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-label-caps font-label-caps text-primary tracking-widest">
              TOOL PANEL
            </h3>
            <span className="text-[10px] font-mono text-outline">v1.0</span>
          </div>
          ...
          <div className="grid grid-cols-2 p-0.5 rounded-lg bg-surface-container border border-outline-variant/60">
            <button
              type="button"
              onClick={() => setTabMode('media')}
