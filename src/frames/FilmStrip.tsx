...
// Strip width as a fraction of composition width - exported so caption
// positioning (getFrameContentInset) can reserve the same amount of space
// instead of duplicating the ratio.
export const FILM_STRIP_WIDTH_RATIO = 0.06;
...
export const FilmStrip: React.FC<FilmStripProps> = ({ children, width, height }) => {
  ...
  const stripWidth = width * FILM_STRIP_WIDTH_RATIO;
